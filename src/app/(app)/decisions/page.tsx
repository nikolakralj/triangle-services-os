...
import { listPersonalInbox } from "@/lib/data/job-intake";
...
export default async function DecisionsPage() {
  ...
  const [
    ...
    getNextMove(org, undefined, session.userId),
    listWhatCameBack(org),
    listWorkforce(org),
    listMissionTabs(org),
    listReadyToContact(org),
    listFollowUpsDue(org, 8, session.userId),
    ...
    listPersonalInbox(org, session.userId),
  ]);
