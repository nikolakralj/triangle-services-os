...
export function CompaniesWorkspace({ initialCompanies }: { initialCompanies: Company[] }) {
  ...
  function addDemoCompany(formData: FormData) {
    ...
    const company: Company = {
      ...
      owner: String(formData.get("owner")) === "Ralph" ? "Ralph" : "Nikola",
        ...
        const imported = results.data
          ...
          .map((row, index): Company => {
            ...
            return {
              ...
              owner: row.owner === "Ralph" ? "Ralph" : "Nikola",
