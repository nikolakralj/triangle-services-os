...
export const EMAIL_CARD_NOTE =
  "Open mail sends nothing. Send from Triangle leaves from your own mailbox and records itself. Sent and replies are observed from the connected mailbox. Recorded outside Triangle is under Dismiss if you already handled this.";
